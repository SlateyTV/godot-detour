...
DetourNavigationMeshParameters::_bind_methods()
{
    ...
    ClassDB::bind_method(D_METHOD("set_max_agent_slope", "slope"), &DetourNavigationMeshParameters::set_max_agent_slope);
    ClassDB::bind_method(D_METHOD("get_max_agent_slope"), &DetourNavigationMeshParameters::get_max_agent_slope);
    ClassDB::bind_method(D_METHOD("set_max_agent_height", "height"), &DetourNavigationMeshParameters::set_max_agent_height);
    ClassDB::bind_method(D_METHOD("get_max_agent_height"), &DetourNavigationMeshParameters::get_max_agent_height);
    ClassDB::bind_method(D_METHOD("set_max_agent_climb", "climb"), &DetourNavigationMeshParameters::set_max_agent_climb);
    ClassDB::bind_method(D_METHOD("get_max_agent_climb"), &DetourNavigationMeshParameters::get_max_agent_climb);
    ClassDB::bind_method(D_METHOD("set_max_agent_radius", "radius"), &DetourNavigationMeshParameters::set_max_agent_radius);
    ClassDB::bind_method(D_METHOD("get_max_agent_radius"), &DetourNavigationMeshParameters::get_max_agent_radius);
    ClassDB::bind_method(D_METHOD("set_max_edge_length", "length"), &DetourNavigationMeshParameters::set_max_edge_length);
    ClassDB::bind_method(D_METHOD("get_max_edge_length"), &DetourNavigationMeshParameters::get_max_edge_length);
    ClassDB::bind_method(D_METHOD("set_max_simplification_error", "max_error"), &DetourNavigationMeshParameters::set_max_simplification_error);
    ClassDB::bind_method(D_METHOD("get_max_simplification_error"), &DetourNavigationMeshParameters::get_max_simplification_error);
    ClassDB::bind_method(D_METHOD("set_min_num_cells_per_island", "cells"), &DetourNavigationMeshParameters::set_min_num_cells_per_island);
    ClassDB::bind_method(D_METHOD("get_min_num_cells_per_island"), &DetourNavigationMeshParameters::get_min_num_cells_per_island);
    ClassDB::bind_method(D_METHOD("set_min_cell_span_count", "count"), &DetourNavigationMeshParameters::set_min_cells_span_count);
    ClassDB::bind_method(D_METHOD("get_min_cell_span_count"), &DetourNavigationMeshParameters::get_min_cells_span_count);
    ClassDB::bind_method(D_METHOD("set_max_verts_per_poly", "verts"), &DetourNavigationMeshParameters::set_max_verts_per_poly);
    ClassDB::bind_method(D_METHOD("get_max_verts_per_poly"), &DetourNavigationMeshParameters::get_max_verts_per_poly);
    ClassDB::bind_method(D_METHOD("set_tile_size", "size"), &DetourNavigationMeshParameters::set_tile_size);
    ClassDB::bind_method(D_METHOD("get_tile_size"), &DetourNavigationMeshParameters::get_tile_size);
    ClassDB::bind_method(D_METHOD("set_layers_per_tile", "layers"), &DetourNavigationMeshParameters::set_layers_per_tile);
    ClassDB::bind_method(D_METHOD("get_layers_per_tile"), &DetourNavigationMeshParameters::get_layers_per_tile);
    ClassDB::bind_method(D_METHOD("set_detail_sample_distance", "distance"), &DetourNavigationMeshParameters::set_detail_sample_distance);
    ClassDB::bind_method(D_METHOD("get_detail_sample_distance"), &DetourNavigationMeshParameters::get_detail_sample_distance);
    ClassDB::bind_method(D_METHOD("set_detail_sample_max_error", "max_error"), &DetourNavigationMeshParameters::set_detail_sample_max_error);
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "max_num_agents"), "set_max_num_agents", "get_max_num_agents");
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "max_agent_slope"), "set_max_agent_slope", "get_max_agent_slope");
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "max_agent_height"), "set_max_agent_height", "get_max_agent_height");
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "max_agent_climb"), "set_max_agent_climb", "get_max_agent_climb");
    ADD_PROPERTY(PropertyInfo(Variant::FLOAT, "max_agent_radius"), "set_max_agent_radius", "get_max_agent_radius");
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "min_num_cells_per_island"), "set_min_num_cells_per_island", "get_min_num_cells_per_island");
    ADD_PROPERTY(PropertyInfo(Variant::INT, "min_cell_span_count"), "set_min_cell_span_count", "get_min_cell_span_count");
